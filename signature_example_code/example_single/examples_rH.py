...
'''导入数据集'''
X_train = np.load('data/simulated_data/rHeston/Xtrain_grid=100_Hbeta_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01.npy')
Y_train = np.load('data/simulated_data/rHeston/Ytrain_grid=100_Hbeta_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01.npy')
X_eval = np.load('data/simulated_data/rHeston/Xeval_grid=100_Hbeta_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01.npy')
Y_eval = np.load('data/simulated_data/rHeston/Yeval_grid=100_Hbeta_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01.npy')
...
plt.savefig('data/results/rHeston_grid=100_Hbeta_kappa1=0.1_kappa2=0.03_theta=0.3_v0=0.01_Trun5.eps', bbox_inches='tight')
