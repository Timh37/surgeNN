...
'''导入数据集'''
X_train = np.load('data/simulated_data/rBergomi/Xtrain_grid=100_Hbeta_eta=1_v0=0.01.npy')
Y_train = np.load('data/simulated_data/rBergomi/Ytrain_grid=100_Hbeta_eta=1_v0=0.01.npy')
X_eval = np.load('data/simulated_data/rBergomi/Xeval_grid=100_Hbeta_eta=1_v0=0.01.npy')
Y_eval = np.load('data/simulated_data/rBergomi/Yeval_grid=100_Hbeta_eta=1_v0=0.01.npy')
...
plt.savefig('data/results/rBergomi_grid=100_Hbeta_eta=1_v0=0.01_Trun5.eps', bbox_inches='tight')
